...
let objThemes = { // the visual look of the marks - each theme supplies the stylesheet strings used when rendering them
    'orange': {
        ...
        'strShowbadge': '.youwatch-watched::after { background-color:#000000; border-radius:2px; color:#FFFFFF; content:"WATCHED"; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:11px; left:4px; opacity:0.8; padding:3px 4px 3px 4px; position:absolute; top:4px; }',
        'strShowwatching': '.youwatch-watching { position:relative; border-radius:12px; overflow:hidden; } .youwatch-watching::after { background-color:#ff8f00; border-radius:8px; box-shadow:0px 1px 4px rgba(0,0,0,0.45); color:#0f0f0f; content:"▶ WATCHING"; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:12px; font-weight:500; left:8px; line-height:normal; opacity:0.95; padding:4px 7px 4px 7px; position:absolute; top:8px; z-index:3; } .youwatch-watching[watchpercent]::after { content:"▶ WATCHING " attr(watchpercent) "%"; } .youwatch-watching::before { background-color:#ff8f00; top:0px; content:""; height:3px; left:0px; position:absolute; width:var(--youwatch-percent, 0%); z-index:3; }',
        'strShowcount': '.youwatch-watched[watchcount]:not([watchcount="0"]):not([watchcount="1"])::before { align-items:center; background-color:rgba(0,0,0,0.6); border-radius:50%; color:#FFFFFF; content:attr(watchcount); display:flex; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:11px; height:18px; justify-content:center; line-height:1; position:absolute; right:19px; top:4px; width:18px; z-index:3; } .youwatch-watching[watchcount]:not([watchcount="0"]):not([watchcount="1"])::after { content:"\u27f3 " attr(watchcount) " \u00b7 WATCHING"; } .youwatch-watching[watchpercent][watchcount]:not([watchcount="0"]):not([watchcount="1"])::after { content:"\u27f3 " attr(watchcount) " \u00b7 WATCHING " attr(watchpercent) "%"; }',
        'strShowactive': '.youwatch-active-label { align-items:center; backdrop-filter:blur(6px); -webkit-backdrop-filter:blur(6px); background-color:rgba(0,0,0,0.50); border-radius:999px; color:#EEEEEE; display:flex; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:14px; font-weight:500; gap:1px; line-height:1; padding:10px 16px; white-space:nowrap; } .youwatch-active-icon { -webkit-text-stroke:0.3px currentColor; font-size:1.4125em; line-height:1; transform:translateY(-0.0867em); }',
    },
    'bw': { // black and white - grayscale on watched, watching keeps its colour with a light fade, both wear a black pill badge
        ...
        'strGrayout': '.youwatch-watched img.ytCoreImageHost, .youwatch-watched .ytp-videowall-still-image { filter:grayscale(1.0); transition:filter 0.25s ease-in-out, opacity 0.25s ease-in-out; } .youwatch-watched:hover img.ytCoreImageHost, .youwatch-watched:hover .ytp-videowall-still-image, .youwatch-watched:hover video, .youwatch-watched.youwatch-hover img.ytCoreImageHost, .youwatch-watched.youwatch-hover .ytp-videowall-still-image, .youwatch-watched.youwatch-hover video { filter:none; }',
        'strShowbadge': '.youwatch-watched::after { background-color:#0f0f0f; border-radius:8px; color:#FFFFFF; content:"WATCHED"; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:12px; font-weight:500; left:8px; line-height:normal; opacity:0.95; padding:4px 7px 4px 7px; position:absolute; top:8px; z-index:3; }',
        'strShowwatching': '.youwatch-watching { position:relative; border-radius:12px; overflow:hidden; } .youwatch-watching::after { background-color:#0f0f0f; border-radius:8px; color:#FFFFFF; content:"WATCHING"; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:12px; font-weight:500; left:8px; line-height:normal; opacity:0.95; padding:4px 7px 4px 7px; position:absolute; top:8px; z-index:3; } .youwatch-watching[watchpercent]::after { content:"WATCHING " attr(watchpercent) "%"; }',
        'strShowcount': '.youwatch-watched[watchcount]:not([watchcount="0"]):not([watchcount="1"])::before, .youwatch-watching[watchcount]:not([watchcount="0"]):not([watchcount="1"])::before { align-items:center; background-color:rgba(15,15,15,0.75); border-radius:50%; color:#FFFFFF; content:attr(watchcount); display:flex; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:12px; font-weight:500; height:22px; justify-content:center; line-height:1; position:absolute; right:23px; top:8px; width:22px; z-index:3; }',
        'strShowactive': '.youwatch-active-label { align-items:center; backdrop-filter:blur(6px); -webkit-backdrop-filter:blur(6px); background-color:rgba(0,0,0,0.50); border-radius:999px; color:#EEEEEE; display:flex; font-family:"YouTube Noto", Roboto, Arial, Helvetica, sans-serif; font-size:14px; font-weight:500; gap:1px; line-height:1; padding:10px 16px; white-space:nowrap; } .youwatch-active-icon { -webkit-text-stroke:0.3px currentColor; font-size:1.4125em; line-height:1; transform:translateY(-0.0867em); }',
    },
};
